...
veg_wgs <- readOGR("/home/ivan/Insync/patagonian_fires/vegetation_valdivian_reclassified/vegetation_valdivian_reclassified.shp")
...
sa_wgs <- readOGR("/home/ivan/Insync/patagonian_fires/study_area/study_area.shp")
