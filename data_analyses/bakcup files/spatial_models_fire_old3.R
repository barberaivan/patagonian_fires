...
ggsave("figures/07) XX curves side by side.png",
       plot = vegs_side,
...
ggsave("figures/06) XX spatial effects summary - predictors.png",
...
ggsave("figures/06) XX spatial effects summary - veg.png",
       width = 16, height = 14, units = "cm")
