...
fireveg <- ggarrange(veg_burn, veg_dist, ncol = 2)
...
# saveRDS(ndvi_models, "data_and_files/models_ndvi.rds")
...
# saveRDS(mtopo, "data_and_files/models_topography.rds")
...
# saveRDS(mdist, "data_and_files/models_distances.rds")
...
saveRDS(fire_models_sim, "data_and_files/fire_models_multivariate.rds")
fire_models_sim <- readRDS("data_and_files/fire_models_multivariate.rds")
...
# saveRDS(result, "data_and_files/fire_models_multreg_result_cov-ndvi-topo-dist.rds")
# saveRDS(result, "data_and_files/fire_models_multreg_result_cov0.rds")
result <- readRDS("data_and_files/fire_models_multreg_result_cov-ndvi-topo-dist.rds")
...
ggsave("figures/05) spatial patterns - fire by veg and topo_cov-topo-ndvi-dist.png",
       plot = fire_multi_topo,
       width = 16, height = 16.5, units = "cm")

fire_multi_pp <- ggarrange(plots = plist_multi[c(6, 5, 7, 8)], ncol = 4)
ggsave("figures/06) spatial patterns - fire by veg and pp-ndvi-dist_cov-topo-ndvi-dist.png",
       plot = fire_multi_pp,
       width = 16, height = 16.5, units = "cm")
...
cov0 <- readRDS("data_and_files/fire_models_multreg_result_cov0.rds")$pred
covall <- readRDS("data_and_files/fire_models_multreg_result_cov-ndvi-topo-dist.rds")$pred
cov0$cov <- "fixed"
...
# ggsave("figures/07) burn probability at common environments_cov0.png",
#        width = 16, height = 13, units = "cm")
ggsave("figures/07) burn probability at common environments_cov-topo.png",
       width = 16, height = 13, units = "cm")
