...
vegmod <- gam(
  list(veg_num ~ s(elevation, k = k_gam, bs = "cr") + s(slope, k = k_gam, bs = "cr") +
                 s(aspect, k = k_gam, bs = "cc") + s(TPI2k, k = k_gam, bs = "cr") +
                 s(pp, k = k_gam, bs = "cr") +
                 s(dist_human, k = k_gam, bs = "cr") + s(dist_roads, k = k_gam, bs = "cr"),

               ~ s(elevation, k = k_gam, bs = "cr") + s(slope, k = k_gam, bs = "cr") + # dry forest
                 s(aspect, k = k_gam, bs = "cc") + s(TPI2k, k = k_gam, bs = "cr") +
                 s(pp, k = k_gam, bs = "cr") +
                 s(dist_human, k = k_gam, bs = "cr") + s(dist_roads, k = k_gam, bs = "cr"),

               ~ s(elevation, k = k_gam, bs = "cr") + s(slope, k = k_gam, bs = "cr") +
                 s(aspect, k = k_gam, bs = "cc") + s(TPI2k, k = k_gam, bs = "cr") +
                 s(pp, k = k_gam, bs = "cr") +
                 s(dist_human, k = k_gam, bs = "cr") + s(dist_roads, k = k_gam, bs = "cr"),
...
pp <- ggplot(data_veg, aes(x = pp, y = elevation)) +
